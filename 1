...
<head>
    ...
    <title>❤️ ¿Me Perdonas? Mon Cher - Intento 1 ❤️</title>
    <style>
        :root {
...
<body>
    ...
    <div class="container">
        <h1 id="question">¿Me perdonas? Mon Cher 🥺 <img id="question-kitty" src="https://media.tenor.com/KkLEtqtOSSUAAAAj/gato-llorar.gif" alt="gatito llorando"></h1>
